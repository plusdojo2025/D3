...
public class OrderHistoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (targetDate != null) {
			...
			baseTime = parsedDate.atTime(12, 0);
			System.out.println("");
		} else {
		...
		formatted = new SimpleDateFormat("yyyy-MM-dd").format(dateAtNoon);
		...
		for (int i = 0; i < list1food.size(); i++) {
			if (list1foodSum[i] == best3foodSum[2] && list1food.get(i) != best3food.get(0)
					&& list1food.get(i) != best3food.get(1)) {
		...
		for (int i = 0; i < list2.size(); i++) {
			if (list2Sum[i] == best3drinkSum[2] && list2.get(i) != best3drink.get(0)
					&& list2.get(i) != best3drink.get(1)) {
				best3drink.add(2, list2.get(i));
			}
		}

		for (int i = 0; i < list3.size(); i++) {
			if (list3Sum[i] == best3drinkSum[2] && list3.get(i) != best3drink.get(0)
					&& list3.get(i) != best3drink.get(1)) {
				best3drink.add(2, list3.get(i));
			}
		}

		for (int i = 0; i < list4.size(); i++) {
			if (list4Sum[i] == best3drinkSum[2] && list4.get(i) != best3drink.get(0)
					&& list4.get(i) != best3drink.get(1)) {
